...
const POST_SUCCESS_PACI = "POST_SUCCESS_PACI";
...
export const Postcitaaction = statusformu => async dispatch => {
    try {
        ...
        const respuesta = await axion.post(
            "api/PostServicios",
            statusformu,
            config
        );
...
export const GuardarPacientesAccion = statusform => async dispatch => {
    const config = {
        headers: {
            "Content-Type": "application/json"
        }
